...
/**
 * The Class InfoAdicionalTargetUrlResolverBOImpl.
 */
public class InfoAdicionalTargetUrlResolverBOImpl implements TargetUrlResolverBO {
	...
	private String resolveURLParameters(Servicio servicio, Map<String, String> info) throws BusinessException {
		try {
			StringBuilder sb = new StringBuilder(servicio.getUrlInfoAdicional());
			...
			throw new BusinessException(CustomError.INFO_ADICIONAL_MALFORMED_URL.getDescription(), e);
		}
	}
